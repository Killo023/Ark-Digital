...
export function Hero() {
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden bg-gradient-to-b from-navy-dark via-navy to-navy-light pt-24 md:pt-28">
      {/* Background Image */}
      <div className="absolute inset-0 z-[1]">
        <Image
          ...
          priority
        />
        <div className="absolute inset-0 bg-gradient-to-b from-navy-dark/90 via-navy/80 to-navy-light/90" />
      </div>
      ...
      <div className="absolute inset-0 overflow-hidden z-[1]">
        <motion.div
          ...
          className="absolute top-0 right-0 w-[800px] h-[800px] bg-gold rounded-full blur-3xl"
        />
        <motion.div
          initial={{ scale: 1.2, opacity: 0 }}
          animate={{ scale: 1, opacity: 0.1 }}
          transition={{ duration: 1.5, delay: 0.2 }}
          className="absolute bottom-0 left-0 w-[600px] h-[600px] bg-gold rounded-full blur-3xl"
        />
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        >
          ...
          <motion.div variants={slideUp} className="mb-6">
            <div className="inline-flex items-center space-x-2 mb-4 px-4 py-2 bg-navy-light/50 backdrop-blur-sm rounded-full border border-gold/20">
            ...
            <h1 className="font-serif text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-bold text-white mb-6 leading-tight">
              ...
              <span className="relative inline-block">
                <span className="relative z-10 text-gold">Digital Solutions</span>
                <motion.span
                  variants={revealCurve}
                  className="absolute bottom-0 left-0 right-0 h-3 bg-gold/20 -z-0"
          ...
          >
            {[
              ...
              <motion.div
                key={item.title}
                variants={fadeIn}
                className="p-4 md:p-6 bg-navy-light/30 backdrop-blur-sm rounded-lg border border-navy-light/50 hover:border-gold/50 transition-all duration-300"
              >
                <item.icon className="h-8 w-8 md:h-10 md:w-10 text-gold mx-auto mb-3" />
          ...
          >
            ...
            <Button
              ...
              variant="outline"
              size="lg"
              className="border-2 border-gold text-gold hover:bg-gold/10 px-8 py-6 text-base"
            >
